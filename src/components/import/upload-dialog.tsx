...
export function UploadDialog({ trigger }: UploadDialogProps) {
  ...
  return (
    ...
    >
      ...
      <DialogContent>
        <DialogHeader>
          <DialogTitle>Import Google Maps CSV</DialogTitle>
          <DialogDescription>
            Upload a CSV export and optionally set a cover image for your collection.
          </DialogDescription>
        </DialogHeader>
          ...
          <div>
            ...
            <Input
              ...
              onChange={(e) => {
                ...
                if (f && !collectionName) {
                  setCollectionName(
                    f.name.replace(/\.csv$/i, "").replace(/[-_]/g, " ")
                  );
                }
              }}
            />
