  ...
  return (
    <div className="mx-auto flex max-w-lg flex-col items-center rounded-3xl border border-border/50 bg-card/40 px-8 py-10 backdrop-blur-sm">
      ...
      <p className="mt-3 text-center text-sm leading-relaxed text-muted">
        Create a collection, then search and save places as you explore — or import a Google
        Maps export if you already have one.
      </p>
      ...
      <p className="mt-4 text-xs text-muted/70">
        Search-powered saves · optional CSV import from Google Maps
      </p>
    </div>
  );
}
